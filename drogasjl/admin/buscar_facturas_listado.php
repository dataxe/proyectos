...
<td><input type="text" name="numero_factura" value="<?php echo $_POST['cod_factura']; ?>" style="font-size:25px" size="4"></td>
...
<input type="hidden" name="numero_factura" value="<?php echo $_POST['cod_factura']; ?>" size="8">
<tr>
