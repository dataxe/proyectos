...
<td align="center" width='90px' title="Cantidad a vender"><strong><font size='3'>UND</font></strong></td>
<td align="center" width='10px'title="Forma de medida del producto, vender por metrica del producto"><strong><font size='3'>MET</font></strong></td>
<td align="center" width='150px' title="Precio costo del producto en metrica, vender segun su respectica metrica"><strong><font size='3'>P.COSTO</font></strong></td>
<td align="center" width='10px' title="Tipo de venta"><strong><font size='3'>T.V</font></strong></td>
<td align="center" title="Iva"><strong><font size='3'>IVA</font></strong></td>
<td align="center" width='150px' title="Precio venta del producto en metrica, vender segun su respectica metrica"><strong><font size='3'>P.VENTA</font></strong></td>
<!--<td align="center" title="Porcentaje de ganancia en caso de vender menudiado"><strong><font size='3'>+%</font></strong></td>-->
<td align="center" width='180px' title="Valor total de la venta"><strong><font size='3'>V.TOTAL</font></strong></td>
<td align="center" title="width='10px'Aceptar los valores insertados"><strong><font size='3'>OK</font></strong></td>
</tr>
<?php
...
$iva_v = $datos['iva_v'];
$iva = ($datos['iva'] / 100) * $precio_costo;
...
?>
<tr>
<td ><a href="../modificar_eliminar/eliminar_temporal_productos.php?cod_productos=<?php echo $datos['cod_productos']?>&cod_temporal=<?php echo $datos['cod_temporal']?>&pagina=<?php echo $pagina?>" tabindex="1"><center><img src=../imagenes/eliminar.png alt="eliminar"></center></a></td>
<td><?php echo $cod_productos;?></td>
<td><?php echo $nombre_productos;?></td>
<!--<td align='right'><?php echo $descripcion;?></td>-->
<td align='center'><input tabindex="0" onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'unidades_vendidas', <?php echo $cod_temporal;?>)" class="cajund" id="<?php echo $cod_temporal;?>" value="<?php echo $unidades_vendidas;?>" size="3"></td>
...
<?php if ($detalles == 'UND') { ?> 
<td title="Venta por unidades completas."><a href="../admin/actualizar_tipo_venta.php?tipo_venta=0&cod_temporal=<?php echo $cod_temporal?>&pagina=<?php echo $pagina?>" tabindex="2"><center><img src=../imagenes/unidad.png alt="unidad"></center></a></td> 
<?php } else {?>
<td title="Venta menudiada."><a href="../admin/actualizar_tipo_venta.php?tipo_venta=1&cod_temporal=<?php echo $cod_temporal?>&pagina=<?php echo $pagina?>" tabindex=3><center><img src=../imagenes/menudiado.png alt="menudiado"></center></a></td>
<?php } ?>

<td align='right'><font size='6'><?php echo number_format($iva, 0, ",", ".");?></font></td>
