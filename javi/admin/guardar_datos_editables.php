...
mysql_query("UPDATE temporal SET unidades_vendidas = '$unidades_vendidas', vlr_total_venta = '$vlr_total_venta', vlr_total_compra = '$vlr_total_compra' 
