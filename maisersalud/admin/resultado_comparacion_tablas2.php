...
$mostrar_datos_sql = "SELECT tcomp.cod_productos, tcomp.cod_camparacion_tablas, tprod.cod_productos_var, tcomp.nombre_productos AS nombre1, 
tcomp.unidades_total, tprod.unidades_faltantes FROM camparacion_tablas AS tcomp, productos AS tprod WHERE tcomp.cod_productos = tprod.cod_productos_var AND cod_factura = '$cod_factura'";
...
<td><font size="3px"><?php echo utf8_decode($nombre1); ?></font></td>
...
if ($resta < 0) {
?>
<td align="center" color="yellow"><font size="3px"><?php echo ($resta * -1)." UNDS ESTRAVIADAS"; ?></font></td>
<?php
}
// SI HAY MAS UNIADES FISICAS QUE EN EL SISTEMA. 
elseif ($resta > 0) {
?>
<td align="center" color="yellow"><font size="3px"><?php echo $resta." UNDS SOBRAN"; ?></font></td>
...
?>
<td align="center" color="white"><font size="3px"><?php echo "BIEN"; ?></font></td>
<?php
}
// SI HAY MAS UNIADES FISICAS QUE EN EL SISTEMA. 
if ($resta > 0) {
