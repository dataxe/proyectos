...
<td><strong>FACTURA: </strong><input type="text" style="font-size:20px" name="numero_factura" value="<?php if ($cantidad_resultado == '1') {
...
<td><strong>FECHA: </strong><input type="text" style="font-size:20px" name="fecha_anyo" value="<?php echo  date("d/m/Y")?>" size="8" required autofocus></td>
...
<td><strong>DESCUENTO: </strong><select name="descuento_factura">
