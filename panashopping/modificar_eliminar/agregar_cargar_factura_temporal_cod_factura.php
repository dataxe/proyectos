...
$agregar_registros_sql2 = sprintf("INSERT INTO cargar_factura_temporal (cod_cargar_factura_temporal, cod_productos, nombre_productos, cod_original, codificacion, unidades, unidades_vendidas, cajas,
precio_compra, precio_venta, vlr_total_venta, vlr_total_compra, detalles, tope_min, vendedor, ip, fecha, fecha_mes, fechas_vencimiento, fechas_vencimiento_seg, dto1, dto2, iva, 
iva_v, ptj_ganancia, porcentaje_vendedor, fecha_anyo, fecha_hora) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
             envio_valores_tipo_sql($_POST['cod_cargar_factura_temporal'], "text"),
...
echo '<META HTTP-EQUIV="REFRESH" CONTENT="0.1; ../admin/cargar_factura_temporal_cod_factura.php">';
}
