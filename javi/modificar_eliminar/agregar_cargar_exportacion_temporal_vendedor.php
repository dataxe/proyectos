...
unidades_total, unidades, unidades_vendidas, cajas, precio_costo, precio_compra, precio_venta, vlr_total_venta, vlr_total_compra, detalles, tope_min, vendedor, ip, fecha, fecha_mes, 
...
echo '<META HTTP-EQUIV="REFRESH" CONTENT="0.1; ../admin/cargar_exportacion_temporal_vendedor.php">';
}
