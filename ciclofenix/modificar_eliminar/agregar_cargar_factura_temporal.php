...
$vlr_total_compra = $datos['precio_costo']; 
...
$reg_factura_temp = "INSERT INTO cargar_factura_temporal (cod_productos, nombre_productos, cod_original, codificacion, 
unidades_total, unidades, cajas, unidades_faltantes, precio_costo, precio_compra, precio_venta, vlr_total_venta, 
vlr_total_compra, precio_compra_con_descuento, detalles, tope_min, vendedor, ip, fecha, fecha_mes, fechas_vencimiento, 
fechas_vencimiento_seg, dto1, dto2, iva, valor_iva, ptj_ganancia, porcentaje_vendedor, fecha_anyo, fecha_hora)
VALUES ('$cod_productos_var', '$nombre_productos', '$cod_original', '$codificacion', '$unidades_total', '$unidades', '$cajas', 
'$unidades_faltantes', '$precio_costo', '$precio_compra', '$precio_venta', '$vlr_total_venta', '$vlr_total_compra', 
'$precio_compra', '$detalles', '$tope_min', '$vendedor', '$ip', '$fecha', '$fecha_mes', '$fechas_vencimiento', 
'$fechas_vencimiento_seg', '$dto1', '$dto2', '$iva', '$valor_iva', '$ptj_ganancia', '$porcentaje_vendedor', '$fecha_anyo', '$fecha_hora')";
