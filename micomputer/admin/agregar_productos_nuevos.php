...
echo "<center><font color='yellow' size='+3'><br><img src=../imagenes/advertencia.gif alt='Advertencia'> El producto ".$filtro_nombre." MARCA ".$matriz_marcas['nombre_marcas']. " existe dentro del inventario del sistema. 
<img src=../imagenes/advertencia.gif alt='Advertencia'></font></center>";
echo"<br><td><a href='../admin/productos.php'><center><font color='yellow' size='+3'>REGRESAR</font></center></a></td>";
echo "<br><center><embed SRC='../sonidos/alarma.mp3' hidden='true' autostart='true' loop='2'></embed></center>";
...
precio_compra, precio_venta, vlr_total_compra, vlr_total_venta, codificacion, utilidad, total_utilidad, descripcion, cod_tipo, cod_lineas, cod_paises, vendedor, cuenta, 
porcentaje_vendedor, dto1, dto2, iva, iva_v, tipo_pago, ip, fechas_vencimiento, fechas_vencimiento_seg, fechas_anyo, fechas_dia, fechas_mes, 
fechas_hora) 
...
'$precio_compra', '$precio_venta', '$vlr_total_compra', '$vlr_total_venta', '$codificacion', '$utilidad', '$total_utilidad', '$descripcion', '$cod_tipo', '$cod_lineas', '$cod_paises', 
'$cuenta_actual', '$cuenta', '$porcentaje_vendedor', '$dto1', '$dto2', '$iva', '$iva_v', '$tipo_pago', '$ip','$fechas_vencimiento', 
'$fechas_vencimiento_seg', '$fechas_anyo', '$fechas_dia', '$fechas_mes', '$fechas_hora')";
