...
<?php $sql_consulta1="SELECT fecha_anyo, cod_factura FROM ventas GROUP BY cod_factura ORDER BY fecha DESC";
...
<td align="right"><font><?php echo $datos['precio_venta']; ?></td></font>
<td align="right"><font><?php echo $datos['vlr_total_venta']; ?></td></font>
<td align="center"><font><?php echo $datos['fecha_anyo']; ?></td></font>
<td align="center"><font><?php echo $datos['fecha_hora']; ?></td></font>
<td  nowrap><a href="../modificar_eliminar/eliminar_productos_factura.php?cod_productos=<?php echo rawurlencode($datos['cod_productos'])?>&cod_ventas=<?php echo urlencode($datos['cod_ventas'])?>&cod_factura=<?php echo $_POST['cod_factura'];?>&pagina=<?php echo $pagina?>"><center><img src=../imagenes/eliminar.png alt="Eliminar"></center></a></td>
</tr>	 
<?php 
}
?>
