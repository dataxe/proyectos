...
sum(precio_compra_con_descuento) as precio_compra_con_descuento, sum(valor_iva) as valor_iva , sum(precio_costo) as precio_costo 
...
<input type="text" style="font-size:15px"  tabindex=3 name="fecha_pago" value="<?php echo date("d/m/Y")?>" size="10" required autofocus>

<td><strong>FACTURA: </strong><input type="text" style="font-size:15px"  tabindex=3 name="numero_factura" value="" size="7" required autofocus>
	
<td><strong>PROVEEDOR: </strong><select name="cod_proveedores" tabindex=3>
...
<td><div align="right"><strong>V.BRUTO(SN.IVA):</strong><input type="text" style="font-size:15px" tabindex=3 name="valor_bruto" value="<?php echo $suma['vlr_total_compra'];?>" size="6" required autofocus></div></td>
<td><div align="right"><strong>DESCUENTO:</strong><input type="text" style="font-size:15px" tabindex=3 name="descuento_factura" value="<?php echo $suma['descuento'];?>" size="6" required autofocus></div></td>
<td><div align="right"><strong>V.NETO:</strong><input type="text" style="font-size:15px" tabindex=3 name="valor_neto" value="<?php echo $suma['vlr_total_compra'];?>" size="6" required autofocus></div></td>
<td><div align="right"><strong>V.IVA:</strong><input type="text" style="font-size:15px" tabindex=3 name="valor_iva" value="<?php echo $suma['valor_iva'];?>" size="6" required autofocus></div></td>
<td><div align="right"><strong>TOTAL:</strong><input type="text" style="font-size:15px" tabindex=3 name="total" value="<?php echo $suma['precio_compra_con_descuento'];?>" size="6" required autofocus></div></td>
