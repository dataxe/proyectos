...
}else{ document.getElementById("logo_cargador").innerHTML='<img src="../imagenes/cargador.gif" width="50" height="50" />'; }
}
xmlhttp.open("POST","busqueda_inmediata_historial_producto_kardex.php",true);
