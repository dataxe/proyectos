...
if ($total_datos <> 0) {
require_once("informacion_factura_venta_admin.php");
}
?>
...
<?php if ($detalles == 'UND') { ?> 
<td title="Venta por unidades completas."><a href="../admin/actualizar_tipo_venta.php?tipo_venta=0&cod_temporal=<?php echo $cod_temporal?>&pagina=<?php echo $pagina?>" tabindex=3><center><img src=../imagenes/unidad.png alt="unidad"></center></a></td> 
<?php } else {?>
