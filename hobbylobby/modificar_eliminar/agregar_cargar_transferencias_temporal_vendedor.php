...
$agregar_registros_sql2 = sprintf("INSERT INTO cargar_transferencias_temporal2 (cod_productos, nombre_productos, cod_original, codificacion, cajas, unidades, unidades_total, 
unidades_vendidas, precio_compra, precio_costo, precio_venta, vlr_total_venta, vlr_total_compra, detalles, tope_min, vendedor, ip, fecha, fecha_mes, fechas_vencimiento, 
...
echo '<META HTTP-EQUIV="REFRESH" CONTENT="0.1; ../admin/transferencias_vendedor.php">';
}
