...
<?php
$sql = "SELECT * FROM cargar_factura_temporal2 WHERE vendedor = '$cuenta_actual' ORDER BY cod_cargar_factura_temporal DESC";
...
<table width="100%">
<tr>
<td align="center"><font size = "+1"><strong>ELM</strong></font></td>
<td align="center"><font size = "+1"><font><strong>C&Oacute;DIGO</strong></font></td>
<td align="center"><font size = "+1"><font><strong>PRODUCTO</strong></font></td>
<td align="center"><font size = "+1"><font><strong>F.VENCTO</strong></font></td>
<td align="center"><font size = "+1"><font><strong>OK</strong></font></td>
</tr>
<?php
...
<td align="center"><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'fechas_vencimiento', <?php echo $cod_productos;?>)" class="alingcenter" id="<?php echo $cod_productos;?>" value="<?php echo $fechas_vencimiento;?>" size="8"></td>
