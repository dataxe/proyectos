...
<ul>
<li><a href="../admin/productos.php">Registrar</a></li>
<li><a href="../admin/actualizar_fecha_vencimiento.php">Fecha Venciment</a></li>
...
<li><a href="../admin/cargar_inventario_copia_vendedores.php">Cargar Vendedor</a></li>
...
<li><a href="../admin/tope_bajo.php">Tope Minimo</a></li>
	<ul>
		   ...
		   <li><a href="../admin/buscar_facturas_vendedor_cod_factura.php">Factura Cod</a></li>
		   <li><a href="../admin/buscar_facturas_vendedor_fecha.php">Factura Fecha</a></li>-->
	</ul>
</li>
<li><a href="#">Ventas</a>
		 <ul>
		 	...
		 	<!--<li><a href="../admin/ventas_vendedor.php">Ventas Vendedor</a></li>-->
		 	<li><a href="../admin/productos_fecha_vencimiento.php">F. Vencimiento</a></li>
		 	<li><a href="../admin/resultado_ventas_barras_vendedor.php">Raya</a></li>
		 	<!--<li><a href="../admin/ventas_diarias_vendedor.php">Venta Diaria</a></li>-->
...
<li><a href="#">Cuentas</a>
		 <ul>
		 	<li><a href="../admin/cuentas_cobrar.php">Cuentas Cobrar</a></li>
		 	<li><a href="../admin/egresos_vendedor.php">Egresos</a></li>
		 </ul>
...
<!--<li><a href="../admin/stiker_productos_transportar.php">Transportar</a></li>-->
</ul>
...
<li><a href="#">Caja</a>
		 <ul>
		 	<li><a href="../admin/caja_registro.php">Caja Reg</a></li>
		 	<li><a href="../admin/listado_caja_registro.php">Listado Caja</a></li>
		 </ul>
