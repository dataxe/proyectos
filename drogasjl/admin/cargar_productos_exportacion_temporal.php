...
<table width="90%">
<tr>
<td align="center"><strong>AGREG</strong></td>
...
<td ><a href="../modificar_eliminar/agregar_cargar_exportacion_temporal.php?cod_productos=<?php echo $datos['cod_productos_var']; ?>"><?php echo $datos['nombre_productos']; ?></a></td>
<td><?php echo $datos['nombre_marcas']; ?></td>
<td><?php echo $datos['nombre_nomenclatura']; ?></td>
<td align="right"><font color='white' size= "+1"><?php echo $datos['unidades_faltantes']; ?></font></td>
<td align="right"><font color='white' size= "+1"><?php echo number_format($datos['precio_costo'], 0, ",", "."); ?></font></td>
<td align="right"><font color='white' size= "+1"><?php echo number_format($datos['precio_venta'], 0, ",", "."); ?></font></td>
</tr>
<?php 
} 
