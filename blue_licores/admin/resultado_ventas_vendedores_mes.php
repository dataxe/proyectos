...
$mostrar_datos_sql = "SELECT * FROM ventas WHERE fecha_mes = '$fecha_mes' AND vendedor = '$vendedor' ORDER BY fecha DESC";
$consulta = mysql_query($mostrar_datos_sql, $conectar) or die(mysql_error());
$matriz_consulta = mysql_fetch_assoc($consulta);

$sql = "SELECT sum(vlr_total_venta) as vlr_total_venta FROM ventas WHERE fecha_mes = '$fecha_mes' AND vendedor = '$vendedor' ORDER BY fecha DESC";
...
<table align="center">
<td nowrap align="right">VENTA MES - VENDEDOR:</td>
<td bordercolor="0">
<select name="fecha">
...
<center>
<?php echo "<strong><font color='yellow' size='+3'>VENTA MES: ".$mostrar."</font></strong>";?>
<table width="100%">
<tr>
