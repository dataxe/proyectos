...
<center>
<br>
<td><strong><font color='white'>FACTURAS CARGADAS POR VENDEDOR: </font></strong></td><br><br>
<form method="GET" name="formulario" action="cargar_factura_temporal_editable_vendedor.php">
<table align="center" id="table">
<td nowrap align="right">FECHA - COD FACTURA:</td>
<td bordercolor="0">
<select name="cod_factura" id="foco">
<?php $sql_consulta1="SELECT DISTINCT cod_factura, fecha_pago FROM cuentas_facturas2 ORDER BY cod_factura ASC";
