...
<ul class="menu">
	...
	<li><a href="#">Facturaci&oacute;n</a>
		   ...
		   <li><a href="../admin/buscar_para_hacer_venta_de_producto_e_inventario_historial.php">Venta- Invent</a></li>
		   <li><a href="../admin/buscar_para_hacer_compra_de_producto_e_inventario_historial.php">Compra- Invent</a></li>
