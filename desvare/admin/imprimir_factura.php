...
<td align="center"><p style="font-size:17px"><?php echo $dat['cabecera'];?> - <?php echo $dat['localidad'];?>
<p style="font-size:17px">Res: <?php echo $dat['res'];?>, Del <?php echo $dat['res1'];?> Al <?php echo $dat['res2'];?> 
- Direccion: <?php echo $dat['direccion'];?>
<br>
Tel: <?php echo $dat['telefono'];?>
<br><?php echo $dat['nit'];?></td>
</table>
<br><br><br><br><br><br><br><br>

<table width="370" align="left">
<td align="left"><p style="font-size:17px"><strong>Fact N&ordm;:</strong> <?php echo $cod_factura;?> | 
<strong>Fecha:</strong> <?php echo $info_fact['fecha_anyo']?>
<br>
<strong>Hora: </strong><?php echo date("H:i")?>
<br>
<strong>Cliente: </strong><?php echo $nombre_cliente;?>
<br>
<strong>Nit: </strong><?php echo $cedula;?>
<br>
<strong>Direccion: </strong><?php echo $direccion;?>
<br>
...
<table width="370" align="left">
<tr>
<td align="left"><strong><p style="font-size:12px">COD</strong></td>
<td align="left"><strong><p style="font-size:12px">DESCRIPCI&Oacute;N</strong></td>
<td align="left"><strong><p style="font-size:12px">UND</strong></td>
<!--<td align="left"><strong><p style="font-size:12px">.</strong></td> -->
<td align="right"><strong><p style="font-size:12px">V.UNIT</strong></td>
<td align="right"><strong><p style="font-size:12px">V.TOTAL</strong></td>
</tr>
<?php do { ?>
<tr>
...
<td align="left"><p style="font-size:12px"><?php echo $info_venta['unidades_vendidas'].''.$info_venta['detalles']; ?></td>
<!--<td align="left"><p style="font-size:12px"><?php echo $info_venta['detalles']; ?></td> -->
<td align="right"><p style="font-size:14px"><?php echo number_format($info_venta['precio_venta'], 0, ",", ".").'|'; ?></td>
<td align="right"><p style="font-size:14px"><?php echo number_format($info_venta['vlr_total_venta'], 0, ",", "."); ?></td>
</tr>
<td>-<td>
<?php
?>
...
<td></td>
<td align='left'><p style="font-size:14px"><strong>SUBTOT: </td> <td align='right'><p style="font-size:14px"><strong><?php echo number_format($subtotal_base, 0, ",", "."); ?></strong></td>
<tr></tr>
<td></td>
<td align='left'><p style="font-size:14px"><strong>%DESC: </td> <td align='right'><p style="font-size:14px"><strong><?php echo $descuento.'%'; ?></strong></td>
<tr></tr>
<td></td>
<td align='left'><p style="font-size:14px"><strong>$DESC: </td> <td align='right'><p style="font-size:14px"><strong><?php echo number_format($total_desc, 0, ",", "."); ?></strong></td>
<tr></tr>
<td></td>
<td align='left'><p style="font-size:14px"><strong>IVA:</td> <td align='right'> <p style="font-size:14px"><strong><?php echo number_format($total_iva, 0, ",", "."); ?></strong></td>
<tr></tr>
<td></td>
<td align='left'><p style="font-size:14px"><strong>TOTAL: </td> <td align='right'><p style="font-size:14px"><strong><?php echo number_format($total_venta_temp, 0, ",", "."); ?></strong>
</td>
</tr>
