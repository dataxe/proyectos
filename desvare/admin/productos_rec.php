...
$mostrar_datos_sql = "SELECT * FROM productos_rec WHERE nombre_productos_rec  like '%$buscar%' order by productos_rec.cod_productos_rec";
...
<?php do { ?>
<tr>
<td><?php echo $matriz_consulta['cod_productos_rec']; ?></td>
<td><?php echo $matriz_consulta['nombre_productos_rec']; ?></td>
<td><?php echo $matriz_consulta['nombre_marcas_rec']; ?></td>
<td><?php echo $matriz_consulta['nombre_proveedores_rec']; ?></td>
<td><?php echo $matriz_consulta['unidades_rec']; ?></td>
<td><?php echo $matriz_consulta['precio_compra_rec']; ?></td>
<td><?php echo $matriz_consulta['precio_venta_rec']; ?></td>
<td><?php echo $matriz_consulta['margen_utilidad_rec']; ?></td>
<td><?php echo $matriz_consulta['descripcion_rec']; ?></td>
</tr>
