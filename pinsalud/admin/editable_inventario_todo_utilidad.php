...
?>
<tr>
<td align='left' title='cod_productos'><?php echo $cod_productos ?></td>
<td align='center' title='cod_productos_var'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'cod_productos_var', <?php echo $cod_productos;?>)" class="cajbarras" id="<?php echo $cod_productos;?>" value="<?php echo $cod_productos_var;?>" size="3"></td>
<td align='left' title='nombre_productos'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'nombre_productos', <?php echo $cod_productos;?>)" class="cajsuper" id="<?php echo $cod_productos;?>" value="<?php echo $nombre_productos;?>" size="3"></td>
<td align='center' title='cod_marcas'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'cod_marcas', <?php echo $cod_productos;?>)" class="cajpequena" id="<?php echo $cod_productos;?>" value="<?php echo $cod_marcas;?>" size="3"></td>
<td align='center' title='cod_proveedores'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'cod_proveedores', <?php echo $cod_productos;?>)" class="cajpequena" id="<?php echo $cod_productos;?>" value="<?php echo $cod_proveedores;?>" size="3"></td>
<td align='center' title='cod_nomenclatura'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'cod_nomenclatura', <?php echo $cod_productos;?>)" class="cajpequena" id="<?php echo $cod_productos;?>" value="<?php echo $cod_nomenclatura;?>" size="3"></td>
<td align='center' title='cod_tipo'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'cod_tipo', <?php echo $cod_productos;?>)" class="cajpequena" id="<?php echo $cod_productos;?>" value="<?php echo $cod_tipo;?>" size="3"></td>
<td align='center' title='cod_lineas'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'cod_lineas', <?php echo $cod_productos;?>)" class="cajpequena" id="<?php echo $cod_productos;?>" value="<?php echo $cod_lineas;?>" size="3"></td>
<td align='center' title='cod_ccosto'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'cod_ccosto', <?php echo $cod_productos;?>)" class="cajpequena" id="<?php echo $cod_productos;?>" value="<?php echo $cod_ccosto;?>" size="3"></td>
<td align='center' title='cod_paises'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'cod_paises', <?php echo $cod_productos;?>)" class="cajpequena" id="<?php echo $cod_productos;?>" value="<?php echo $cod_paises;?>" size="3"></td>
<td align='center' title='numero_factura'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'numero_factura', <?php echo $cod_productos;?>)" class="cajgrand" id="<?php echo $cod_productos;?>" value="<?php echo $numero_factura;?>" size="3"></td>
<td align='center' title='unidades'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'unidades', <?php echo $cod_productos;?>)" class="cajgrand" id="<?php echo $cod_productos;?>" value="<?php echo $unidades;?>" size="3"></td>
<td align='center' title='cajas'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'cajas', <?php echo $cod_productos;?>)" class="cajgrand" id="<?php echo $cod_productos;?>" value="<?php echo $cajas;?>" size="3"></td>
<td align='center' title='unidades_total'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'unidades_total', <?php echo $cod_productos;?>)" class="cajgrand" id="<?php echo $cod_productos;?>" value="<?php echo $unidades_total;?>" size="3"></td>
<td align='center' title='unidades_faltantes'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'unidades_faltantes', <?php echo $cod_productos;?>)" class="cajgrand" id="<?php echo $cod_productos;?>" value="<?php echo $unidades_faltantes;?>" size="3"></td>
<td align='center' title='precio_compra'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'precio_compra', <?php echo $cod_productos;?>)" class="cajgrand" id="<?php echo $cod_productos;?>" value="<?php echo $precio_compra;?>" size="3"></td>
<td align='center' title='precio_costo'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'precio_costo', <?php echo $cod_productos;?>)" class="cajgrand" id="<?php echo $cod_productos;?>" value="<?php echo $precio_costo;?>" size="3"></td>
<td align='center' title='precio_venta'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'precio_venta', <?php echo $cod_productos;?>)" class="cajgrand" id="<?php echo $cod_productos;?>" value="<?php echo $precio_venta;?>" size="3"></td>
<td align='center' title='vlr_total_compra'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'vlr_total_compra', <?php echo $cod_productos;?>)" class="cajgrand" id="<?php echo $cod_productos;?>" value="<?php echo $vlr_total_compra;?>" size="3"></td>
<td align='center' title='vlr_total_venta'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'vlr_total_venta', <?php echo $cod_productos;?>)" class="cajgrand" id="<?php echo $cod_productos;?>" value="<?php echo $vlr_total_venta;?>" size="3"></td>
<td align='center' title='cod_interno'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'cod_interno', <?php echo $cod_productos;?>)" class="cajgrand" id="<?php echo $cod_productos;?>" value="<?php echo $cod_interno;?>" size="3"></td>
<td align='center' title='tope_minimo'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'tope_minimo', <?php echo $cod_productos;?>)" class="cajgrand" id="<?php echo $cod_productos;?>" value="<?php echo $tope_minimo;?>" size="3"></td>
<td align='center' title='descuento'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'descuento', <?php echo $cod_productos;?>)" class="cajgrand" id="<?php echo $cod_productos;?>" value="<?php echo $descuento;?>" size="3"></td>
<td align='center' title='tipo_pago'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'tipo_pago', <?php echo $cod_productos;?>)" class="cajgrand" id="<?php echo $cod_productos;?>" value="<?php echo $tipo_pago;?>" size="3"></td>
<td align='center' title='ip'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'ip', <?php echo $cod_productos;?>)" class="cajgrand" id="<?php echo $cod_productos;?>" value="<?php echo $ip;?>" size="3"></td>
<td align='center' title='codificacion'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'codificacion', <?php echo $cod_productos;?>)" class="cajgrand" id="<?php echo $cod_productos;?>" value="<?php echo $codificacion;?>" size="3"></td>
<td align='center' title='url'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'url', <?php echo $cod_productos;?>)" class="cajgrand" id="<?php echo $cod_productos;?>" value="<?php echo $url;?>" size="3"></td>
<td align='center' title='cod_original'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'cod_original', <?php echo $cod_productos;?>)" class="cajgrand" id="<?php echo $cod_productos;?>" value="<?php echo $cod_original;?>" size="3"></td>
<td align='center' title='detalles'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'detalles', <?php echo $cod_productos;?>)" class="cajgrand" id="<?php echo $cod_productos;?>" value="<?php echo $detalles;?>" size="3"></td>
<td align='center' title='descripcion'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'descripcion', <?php echo $cod_productos;?>)" class="cajgrand" id="<?php echo $cod_productos;?>" value="<?php echo $descripcion;?>" size="3"></td>
<td align='center' title='dto1'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'dto1', <?php echo $cod_productos;?>)" class="cajpequena" id="<?php echo $cod_productos;?>" value="<?php echo $dto1;?>" size="3"></td>
<td align='center' title='dto2'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'dto2', <?php echo $cod_productos;?>)" class="cajpequena" id="<?php echo $cod_productos;?>" value="<?php echo $dto2;?>" size="3"></td>
<td align='center' title='iva'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'iva', <?php echo $cod_productos;?>)" class="cajpequena" id="<?php echo $cod_productos;?>" value="<?php echo $iva;?>" size="3"></td>
<td align='center' title='iva_v'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'iva_v', <?php echo $cod_productos;?>)" class="cajgrand" id="<?php echo $cod_productos;?>" value="<?php echo $iva_v;?>" size="3"></td>
<td align='center' title='fechas_dia'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'fechas_dia', <?php echo $cod_productos;?>)" class="cajbarras" id="<?php echo $cod_productos;?>" value="<?php echo $fechas_dia;?>" size="3"></td>
<td align='center' title='fechas_mes'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'fechas_mes', <?php echo $cod_productos;?>)" class="cajbarras" id="<?php echo $cod_productos;?>" value="<?php echo $fechas_mes;?>" size="3"></td>
<td align='center' title='fechas_anyo'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'fechas_anyo', <?php echo $cod_productos;?>)" class="cajbarras" id="<?php echo $cod_productos;?>" value="<?php echo $fechas_anyo;?>" size="3"></td>
<td align='center' title='fechas_hora'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'fechas_hora', <?php echo $cod_productos;?>)" class="cajbarras" id="<?php echo $cod_productos;?>" value="<?php echo $fechas_hora;?>" size="3"></td>
<td align='center' title='fechas_vencimiento'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'fechas_vencimiento', <?php echo $cod_productos;?>)" class="cajbarras" id="<?php echo $cod_productos;?>" value="<?php echo $fechas_vencimiento;?>" size="3"></td>
<td align='center' title='porcentaje_vendedor'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'porcentaje_vendedor', <?php echo $cod_productos;?>)" class="cajgrand" id="<?php echo $cod_productos;?>" value="<?php echo $porcentaje_vendedor;?>" size="3"></td>
<td align='center' title='fechas_vencimiento_seg'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'fechas_vencimiento_seg', <?php echo $cod_productos;?>)" class="cajbarras" id="<?php echo $cod_productos;?>" value="<?php echo $fechas_vencimiento_seg;?>" size="3"></td>
<td align='center' title='fechas_agotado'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'fechas_agotado', <?php echo $cod_productos;?>)" class="cajbarras" id="<?php echo $cod_productos;?>" value="<?php echo $fechas_agotado;?>" size="3"></td>
<td align='center' title='fechas_agotado_seg'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'fechas_agotado_seg', <?php echo $cod_productos;?>)" class="cajbarras" id="<?php echo $cod_productos;?>" value="<?php echo $fechas_agotado_seg;?>" size="3"></td>
<td align='center' title='vendedor'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'vendedor', <?php echo $cod_productos;?>)" class="cajgrand" id="<?php echo $cod_productos;?>" value="<?php echo $vendedor;?>" size="3"></td>
<td align='center' title='cuenta'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'cuenta', <?php echo $cod_productos;?>)" class="cajgrand" id="<?php echo $cod_productos;?>" value="<?php echo $cuenta;?>" size="3"></td>
</tr>
<?php } ?>
</table>
</form>
