...
$nombre_proveedores = $_GET['nombre_proveedores'];
$fecha = $_GET['fecha'];
...
sum(vlr_total_venta * cajas) AS vlr_total_ventas FROM facturas_cargadas_inv WHERE fecha_mes = '$fecha' AND cod_proveedores = '$cod_proveedores'";
...
$mostrar_datos_sql = "SELECT * FROM facturas_cargadas_inv WHERE fecha_mes = '$fecha' AND cod_proveedores = '$cod_proveedores'";
...
<body>
<br><a href="../admin/factura_compra_mensual.php?fecha=<?php echo $fecha ?>"><font color='white'><strong>REGRESAR</font></strong></font></a></td><br><br>
<?php
if ($fecha <> NULL) {?>
<center>
<fieldset><legend><font color='yellow' size='+3'>COMPRAS TOTALES MES: <?php echo $fecha.' - '.$nombre_proveedores;?></font></legend>
<table width='40%'>
<br>
<tr>
...
-->
<br>
<fieldset><legend><font color='yellow' size='+3'>COMPRAS MES: <?php echo $fecha.' - '.$nombre_proveedores;?></font></legend>
<table width='100%'>
<tr>
