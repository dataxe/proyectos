...
<table width="263" align="left">
<td align="center"><p style="font-size:12px"><strong><?php echo $dat['cabecera'];?></strong> <br> <?php echo $dat['localidad'];?>
<p style="font-size:12px">Res: <?php echo $dat['res'];?>, Del <?php echo $dat['res1'];?> Al <?php echo $dat['res2'];?> 
- <br>Dir: <?php echo $dat['direccion'];?>
<br>
...
<table width="263" align="left">
<td align="left"><p style="font-size:12px"><strong>Fact N&ordm;:</strong> <?php echo $cod_factura;?> | 
...
<!--<td align="left"><strong><p style="font-size:9px">.</strong></td> -->
<td align="left"><strong><p style="font-size:9px">V.UNIT</strong></td>
...
<td align="left"><p style="font-size:9px"><?php echo utf8_encode($info_venta['nombre_productos']); ?></td>
<td align="center"><p style="font-size:9px"><?php echo $info_venta['unidades_vendidas']; ?></td>
<!--<td align="left"><p style="font-size:9px"><?php echo $info_venta['detalles']; ?></td> -->
<td align="right"><p style="font-size:11px"><?php echo number_format($info_venta['precio_venta'], 0, ",", ".").'|'; ?></td>
<td align="right"><p style="font-size:11px"><?php echo number_format($info_venta['vlr_total_venta'], 0, ",", "."); ?></td>
</tr>
...
<td></td>
<td align='left'><p style="font-size:12px"><strong>SUBTOT:</td>
<td></td><td></td>
<td align='right'><p style="font-size:12px"><strong><?php echo number_format($subtotal_base, 0, ",", "."); ?></strong></td>
<tr></tr>
<td></td>
<td align='left'><p style="font-size:12px"><strong>%DESC:</td>
<td></td><td></td>
<td align='right'><p style="font-size:12px"><strong><?php echo $descuento.'%'; ?></strong></td>
<tr></tr>
<td></td>
<td align='left'><p style="font-size:12px"><strong>$DESC:</td>
<td></td><td></td>
<td align='right'><p style="font-size:12px"><strong><?php echo number_format($total_desc, 0, ",", "."); ?></strong></td>
<tr></tr>
<td></td>
<td align='left'><p style="font-size:12px"><strong>IVA:</td>
<td></td><td></td>
<td align='right'> <p style="font-size:12px"><strong><?php echo number_format($total_iva, 0, ",", "."); ?></strong></td>
<tr></tr>
<td></td>
<td align='left'><p style="font-size:12px"><strong>TOTAL:</td>
<td></td><td></td>
<td align='right'><p style="font-size:12px"><strong><?php echo number_format($total_venta_temp, 0, ",", "."); ?></strong>
</td>
</tr>
<!--<td align="justify"><p style="font-size:9px"><?php //echo $dat['info_legal'];?></td>-->
