...
if($buscar <> "") {
$mostrar_datos_sql = "SELECT cod_productos_var, nombre_productos, unidades, unidades_faltantes, precio_costo, precio_venta, detalles,
descripcion, codificacion, numero_factura, fechas_anyo FROM productos WHERE nombre_productos like '$buscar%' OR cod_productos_var = '$buscar'";
...
<td align="left"><?php echo $datos['nombre_productos']; ?></td>
