...
<body>
<?php
$buscar = mysql_escape_string($_POST['palabra']);
...
<td align="right"><?php echo number_format($matriz_consulta['precio_compra'], 0, ",", "."); ?></td>
<td align="right"><?php echo number_format($matriz_consulta['precio_venta'], 0, ",", "."); ?></td>
<td align="right"><?php echo number_format($matriz_consulta['utilidad'], 0, ",", "."); ?></td>
