...
$buscar = $_POST['fecha'];
$mostrar_datos_sql = "SELECT * FROM ventas WHERE fecha_mes like '%$buscar%' AND unidades_vendidas <> '0' ORDER BY fecha_hora DESC";
...
<table align="center">
<td nowrap align="right">Ventas Mensuales:</td>
<td bordercolor="0">
<select name="fecha">
