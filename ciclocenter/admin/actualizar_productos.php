...
(prod.cod_marcas = marc.cod_marcas AND (prod.cod_productos_var = '$buscar' OR prod.nombre_productos like '$buscar%')) order by prod.nombre_productos DESC";
...
<td><div class="select" id="cod_proveedores-<?php echo $id?>"><?php echo $datos['nombre_marcas'];?></td>
