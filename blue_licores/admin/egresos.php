...
$fecha_mes = mysql_escape_string($_GET['fecha_mes']);
$mostrar_datos_sql = "SELECT * FROM egresos WHERE fecha_mes = '$fecha_mes' order by fecha_invert DESC";
...
<?php do { ?>
<tr>
<td ><a href="../modificar_eliminar/eliminar_egresos.php?cod_egresos=<?php echo $datos['cod_egresos']?>&pagina=<?php echo $pagina?>"><center><img src=../imagenes/eliminar.png alt="eliminar"></center></a></td>
