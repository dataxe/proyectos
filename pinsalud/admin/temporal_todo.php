...
require_once("busqueda_inmediata_todo_act.php");
if ($total_datos <> 0) {
...
?>
<tr>
<td ><a href="../modificar_eliminar/eliminar_temporal_productos.php?cod_productos=<?php echo $cod_productos?>&cod_temporal=<?php echo $cod_temporal?>&pagina=<?php echo $pagina?>"><center><img src=../imagenes/eliminar.png alt="eliminar"></center></a></td>
<td><?php echo $cod_productos;?></td>
<td><?php echo $nombre_productos;?></td>

<?php if ($tipo_venta == '1') { ?> 
<td><a href="../admin/actualizar_tipo_venta.php?tipo_venta=0&cod_temporal=<?php echo $cod_temporal?>&cod_productos=<?php echo $cod_productos?>&pagina=<?php echo $pagina?>"><center><img src=../imagenes/unidad.png alt="unidad"><?php echo $unidades_cajas?></center></a></td> 
<?php } else {?>
<td><a href="../admin/actualizar_tipo_venta.php?tipo_venta=1&cod_temporal=<?php echo $cod_temporal?>&cod_productos=<?php echo $cod_productos?>&pagina=<?php echo $pagina?>"><center><img src=../imagenes/menudiado.png alt="menudiado"></center></a></td>
<?php } ?>
