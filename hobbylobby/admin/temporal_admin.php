...
<td align='center'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'precio_costo', <?php echo $cod_temporal;?>)" class="cajvtotal" id="<?php echo $cod_temporal;?>" value="<?php echo $precio_costo;?>" size="3"></td>
