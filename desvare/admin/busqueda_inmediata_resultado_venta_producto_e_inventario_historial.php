...
$mostrar_datos_sql = "SELECT cod_ventas, cod_productos, cod_factura, cod_clientes, nombre_productos, unidades_vendidas, precio_venta, 
detalles, fecha, fecha_hora, vendedor, unidades_faltantes_inv FROM ventas WHERE (cod_productos = '$buscar') ORDER BY fecha DESC";
...
$suma_nuevos_viejos = $unidades_faltantes_inv - $unidades_vendidas;
?>
<td><font size ='3px'><?php echo $cod_productos; ?></font></td>
<td><font size ='3px'><?php echo $nombre_productos; ?></font></td>
<td align="center"><font size ='3px'><?php echo $unidades_vendidas; ?></font></td>
<td align="center"><font size ='3px'><?php echo $unidades_faltantes_inv; ?></font></td>
