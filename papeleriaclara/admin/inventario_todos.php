...
sum(vlr_total_compra) As vlr_total_compra, Sum(((precio_venta/1.16)*(iva/100))*unidades_vendidas) As sum_iva FROM ventas WHERE tipo_pago ='1'";
...
sum(vlr_total_compra) As vlr_total_compra, Sum(((precio_venta/1.16)*(iva/100))*unidades_vendidas) As sum_iva FROM ventas WHERE tipo_pago ='2'";
...
$total_ganancia = $total_venta_contado - ($vlr_total_compra + $total_egreso + $total_caja);
...
<body>
<center>
<fieldset><legend><font color='yellow' size='+3'>VENTAS TOTALES TODAS</font></legend>
<table width='100%'>
<br>
<tr>
...
<center>
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="../admin/imprimir_datos_ventas_pequena_todos.php?fecha=<?php echo $fecha?>&campo=<?php echo $campo?>" target="_blank"><img src=../imagenes/imprimir_1.png alt="imprimir"></a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</td>
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="../admin/imprimir_datos_ventas_grande_todos.php?fecha=<?php echo $fecha?>&campo=<?php echo $campo?>" target="_blank"><img src=../imagenes/imprimir_.png alt="imprimir"></a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</td>
</center>
</table>
...
<br>
<fieldset><legend><font color='yellow' size='+3'>VENTAS TODAS</font></legend>
<table width='100%'>
<tr>
...
<?php mysql_free_result($consulta_venta);?>
<?php //require_once('totales.php');?>