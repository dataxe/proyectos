...
precio_compra_con_descuento, detalles, tope_min, vendedor, ip, fecha, fecha_mes, fechas_vencimiento, fechas_vencimiento_seg, 
...
'$unidades', '$cajas', '$precio_compra', '$precio_venta', '$precio_costo', '$vlr_total_venta', '$vlr_total_compra', 
'$precio_compra', '$detalles', '$tope_min', '$vendedor', '$ip', '$fecha', '$fecha_mes', '$fechas_vencimiento', '$fechas_vencimiento_seg', 
'$dto1', '$dto2', '$iva', '$valor_iva', '$ptj_ganancia', '$porcentaje_vendedor', '$fecha_anyo', '$fecha_hora')";
