...
?>
<td align="center"><input onblur="validar_codigo(this);" type="text" style="font-size:20px" name="cod_productos_var" value="<?php echo $_GET['plus'] ?>" id="cod_productos_var" size="13" required autofocus/></td>
...
<td align="center" title="Precio costo total del producto"><input type="text"style="font-size:20px" name="precio_compra" value="" size="4" required autofocus></td>
<td align="center" title="Precio venta total del producto"><input type="text" style="font-size:20px" name="precio_venta" value="" size="4" required autofocus></td>
