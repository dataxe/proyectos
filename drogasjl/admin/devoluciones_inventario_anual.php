...
<br><br>
<center>
<td align="center"><font color="yellow" size="+2"><strong>DEVOLUCIONES INVENTARIO ANUAL</font></td>
<br>
...
<?php 
$sql_consulta = "SELECT DISTINCT anyo FROM operacion ORDER BY anyo DESC";
...
$deboluciones_inventario = "SELECT * FROM operacion WHERE origen_operacion = 'productos' AND anyo = '$fecha'";
