...
//PARA UNIDADES
if ($campo == 'unidades' && $detalles <> 'UND') {
...
$vlr_total_venta = $precio_compra + ($precio_compra * ($datos['ptj_ganancia']/100));
$precio_venta = $vlr_total_venta / $datos['unidades'];
//$vlr_total_venta = $precio_compra_con_descuento + ($precio_compra_con_descuento * ($datos['ptj_ganancia']/100));
//$precio_venta =  $vlr_total_venta / $datos['unidades'];
...
//PARA CODIGO INTERNO
if ($campo == 'cod_interno') {
$cod_interno = strtoupper($valor_intro);
mysql_query("UPDATE cargar_factura_temporal SET cod_interno = '$cod_interno' WHERE cod_cargar_factura_temporal = '$cod_cargar_factura_temporal'", $conectar);
}
}
?>