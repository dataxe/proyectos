...
$total_venta_neta = ($suma['total_venta_neta'], 0, ",", ".");
$subtotal_base = ($suma['subtotal_base'], 0, ",", ".");
$total_desc = ($suma['total_desc'], 0, ",", ".");
$total_iva = ($suma['total_iva'], 0, ",", ".");
$total_venta_temp = ($suma['total_venta'], 0, ",", ".");
}
?>
