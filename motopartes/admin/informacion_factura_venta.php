...
<td align='center'><input type="hidden" style="font-size:20px" name="numero_factura" value="<?php if ($cantidad_resultado == '1') {
echo $info['cod_factura']; } else { echo $maxima['cod_factura']+1;}?>" size="3" required autofocus></td>

<td align='left'><strong>FACTURA: </strong><font size= "+1"><?php if ($cantidad_resultado == '1') {
echo $info['cod_factura']; } else { echo $maxima['cod_factura']+1;}?></font></td>
...
<td><strong>FECHA PAGO: </strong><input type="text" style="font-size:20px" name="fecha_pago" value="<?php echo  date("d/m/Y")?>" tabindex=3 size="8" required autofocus></td>
...
<!--<td align='center'><strong>T.COSTO: </strong><font size= "+3"><?php echo number_format($matriz_temporal['total_compra']); ?></font></td>-->
...
<td align='center'><a><input type="image" src="../imagenes/ok.png" name="vender" value="Guardar" tabindex=3/></a></td>
</table>
