...
$borrar_sql1 = sprintf("DELETE FROM info_camparacion_tablas WHERE cod_factura = '$cod_factura'");
$Result1 = mysql_query($borrar_sql1, $conectar) or die(mysql_error());

$borrar_sql2 = sprintf("DELETE FROM camparacion_tablas WHERE cod_factura = '$cod_factura'");
