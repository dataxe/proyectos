...
<td><input type="hidden" style="font-size:20px" name="numero_factura" tabindex=3 value="<?php if ($cantidad_resultado == '1') {
...
<input type="hidden" style="font-size:20px" name="fecha_anyo" tabindex=3 value="<?php echo  date("d/m/Y")?>" size="8" required autofocus>
...
<td><a><input type="image" src="../imagenes/ok.png" name="vender" tabindex=3 value="Guardar" /></a></td>
</table>
