...
<?php 
$sql_consulta = "SELECT DISTINCT fecha_mes FROM operacion WHERE origen_operacion = 'ventas' ORDER BY fecha DESC";
...
$deboluciones_inventario = "SELECT * FROM operacion WHERE origen_operacion = 'ventas' AND fecha_mes = '$fecha' ORDER BY fecha_time DESC";
