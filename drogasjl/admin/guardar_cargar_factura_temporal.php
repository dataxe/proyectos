...
mysql_query("UPDATE cargar_factura_temporal SET vlr_total_venta = '$vlr_total_venta' WHERE cod_cargar_factura_temporal = '$cod_cargar_factura_temporal'", $conectar);
}
...
mysql_query("UPDATE cargar_factura_temporal SET ptj_ganancia = '$ptj_ganancia', precio_venta = '$precio_venta', vlr_total_venta = '$vlr_total_venta' 
