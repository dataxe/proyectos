...
--
-- Servidor: localhost
-- Tiempo de generación: 01-09-2017 a las 18:15:21
...
--
-- Estructura de tabla para la tabla `productos_copia_seguridad`
--

CREATE TABLE IF NOT EXISTS `productos_copia_seguridad` (
  `cod_productos_copia_seguridad` int(10) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`cod_productos_copia_seguridad`),
  UNIQUE KEY `cod_productos_var` (`cod_productos_var`),
  KEY `nombre_productos` (`nombre_productos`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;

--
-- Volcar la base de datos para la tabla `productos_copia_seguridad`
--
