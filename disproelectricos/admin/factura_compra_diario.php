...
sum(vlr_total_venta * cajas) AS vlr_total_ventas FROM facturas_cargadas_inv WHERE fecha_anyo = '$fecha'";
...
$mostrar_datos_sql = "SELECT * FROM facturas_cargadas_inv, proveedores WHERE fecha_anyo = '$fecha' 
AND proveedores.cod_proveedores = facturas_cargadas_inv.cod_proveedores";
...
<table align="center">
<td nowrap align="right">FACTURA COMPRA DIARIA:</td>
<td bordercolor="0">
<select name="fecha" id="foco">
<?php $sql_consulta1="SELECT DISTINCT fecha, fecha_anyo FROM facturas_cargadas_inv ORDER BY fecha DESC";
...
if ($fecha <> NULL) {?>
<center>
<fieldset><legend><font color='yellow' size='+3'>COMPRAS TOTALES DIA: <?php echo $fecha.' - '.$hora;?></font></legend>
<table width='40%'>
<br>
<tr>
...
<br>
<fieldset><legend><font color='yellow' size='+3'>COMPRAS DIA: <?php echo $fecha.' - '.$hora;?></font></legend>
<table width='100%'>
<tr>
