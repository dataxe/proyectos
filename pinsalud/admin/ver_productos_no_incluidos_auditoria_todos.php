...
$mostrar_datos_sql = "SELECT cod_productos_var, nombre_productos, unidades_faltantes FROM productos WHERE productos.unidades_faltantes <> '0' 
AND not exists (SELECT * FROM camparacion_tablas WHERE camparacion_tablas.cod_productos= productos.cod_productos_var)";
...
<table width="70%">
<tr>
<td align="center"><strong><font size='+1'>TOTAL NO INCLUIDOS EN AUDITORIAS <> 0</font></strong></td>
