...
$numer_factura = $_POST['cod_facturacion'];
?>
<center>
...
<?php $sql_consulta1="SELECT DISTINCT cod_facturacion, fecha FROM facturacion ORDER BY fecha DESC";
...
?>
<option value="<?php echo $contenedor['cod_facturacion'] ?>"><?php echo $contenedor['fecha'] ?></option>
<?php }?>
</select></td>
<tr valign="baseline">
...
<td><div align="center"><strong><p style="font-size:14px"><?php echo $matriz_informacion['nombre'];?><br>
<?php echo $matriz_informacion['localidad'];?><br><br>
