...
$sql_modificar_consulta = "SELECT * FROM cargar_transferencias_temporal WHERE cod_productos = '$cod_productos'";
...
mysql_query("UPDATE cargar_transferencias_temporal SET precio_venta = '$precio_venta', vlr_total_compra = '$vlr_total_compra', vlr_total_venta = '$vlr_total_venta', precio_costo = '$precio_costo', 
...
mysql_query("UPDATE cargar_transferencias_temporal SET porcentaje_vendedor = '$porcentaje_vendedor' WHERE cod_productos = '$cod_productos'", $conectar);
}
if ($campo == 'ptj_ganancia') {
$ptj_ganancia = $valor_intro;
mysql_query("UPDATE cargar_transferencias_temporal SET ptj_ganancia = '$ptj_ganancia' WHERE cod_productos = '$cod_productos'", $conectar);
}
...
mysql_query("UPDATE cargar_transferencias_temporal SET tope_min = '$tope_min' WHERE cod_productos = '$cod_productos'", $conectar);
}
if ($campo == 'detalles') {
$detalles = $valor_intro;
mysql_query("UPDATE cargar_transferencias_temporal SET detalles = '$detalles' WHERE cod_productos = '$cod_productos'", $conectar);
}
if ($campo == 'iva_v') {
$iva_v = $valor_intro;
mysql_query("UPDATE cargar_transferencias_temporal SET iva_v = '$iva_v' WHERE cod_productos = '$cod_productos'", $conectar);
}
if ($campo == 'nombre_productos') {
$nombre_productos = $valor_intro;
mysql_query("UPDATE cargar_transferencias_temporal SET nombre_productos = '$nombre_productos' WHERE cod_productos = '$cod_productos'", $conectar);
}
if ($campo == 'cod_original') {
$cod_original = $valor_intro;
mysql_query("UPDATE cargar_transferencias_temporal SET cod_original = '$cod_original' WHERE cod_productos = '$cod_productos'", $conectar);
}
if ($campo == 'codificacion') {
$codificacion = $valor_intro;
mysql_query("UPDATE cargar_transferencias_temporal SET codificacion = '$codificacion' WHERE cod_productos = '$cod_productos'", $conectar);
}
}
?>