...
GROUP BY cuentas_cobrar.cod_clientes ORDER BY cuentas_cobrar.fecha_invert DESC";
...
<td align="right"><a href="../admin/cuentas_cobrar_abonos.php?cod_clientes=<?php echo $cod_clientes;?>&cliente=<?php echo $cliente;?>"><font size='3'><?php echo number_format($abonado, 0, ",", ".");?></font></a></td>
