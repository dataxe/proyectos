...
<td align='left'><strong>FECHA: </strong><input type="text" style="font-size:20px" tabindex=3 name="fecha_anyo" value="<?php echo  date("d/m/Y")?>" size="8" required autofocus></td>
