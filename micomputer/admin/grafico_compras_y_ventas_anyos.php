...
?>
        ...
        series: [{
            ...
            data: [
<?php
$sql = "SELECT SUM(vlr_total_venta) AS total_venta FROM ventas GROUP BY anyo ORDER BY anyo ASC";
$result = mysql_query($sql, $conectar) or die(mysql_error());
while ($registros = mysql_fetch_array($result)) {
?>
...
?>
            ...
            data: [
<?php
$sql = "SELECT SUM(precio_costo*unidades_total) AS total_compra FROM facturas_cargadas_inv GROUP BY anyo ORDER BY anyo ASC";
$result = mysql_query($sql, $conectar) or die(mysql_error());
while ($registros = mysql_fetch_array($result)) {
?>
