...
?>
<center>
<table id="numero_factura" width="215">
...
<td><input type="text" name="fech" value="<?php echo $matriz_fecha['fecha']; ?>" size="9"></td>
 </tr>
</table>
</center>
<?php
...
<td><div align="center"><strong>SUBTOTAL</strong></div></td>
<td><div align="center"><strong>IVA INCLUIDO</strong></div></td>
<td><div align="center"><strong>FLETE</strong></div></td>
<td><div align="center"><strong>VLR CANCELADO</strong></div></td>
...
<td width="10"><input type="text" name="flete" value="0" size="15" required autofocus></td>
