...
<li><a href="../admin/cargar_exportacion_temporal_vendedor.php">Cargar Export</a></li>-->
...
<li><a href="#">Ventas</a>
		 <ul>
		 	<li><a href="../admin/temporal_todo.php">Manual</a></li>
...
<li><a href="../admin/cuentas_cobrar.php">Cuentas Cobrar</a>
<li><a href="#">Stiker</a>
<ul>
<li><a href="../admin/stiker_productos_fecha.php">Crear Barras</a></li>
<li><a href="../admin/glosario_vendedor.php">Glosario</a></li>
<!--<li><a href="../admin/exportacion_csv_vendedor.php">Actualizar Sist</a></li>
