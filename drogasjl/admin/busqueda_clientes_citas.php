...
<?php do { ?>
<td ><a href="../modificar_eliminar/agregar_cargar_factura_temporal.php?cod_productos=<?php echo $matriz_consulta['cod_productos_var']; ?>"><img src=../imagenes/agregar.png alt="Agregar"></a></td>
