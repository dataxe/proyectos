...
$mostrar = $fecha_dmy.' - '.$vendedor;

$mostrar_datos_sql = "SELECT * FROM ventas WHERE fecha = '$fecha' AND vendedor = '$vendedor' AND porcentaje_vendedor = 'si' ORDER BY fecha DESC";
$consulta = mysql_query($mostrar_datos_sql, $conectar) or die(mysql_error());
$datos = mysql_fetch_assoc($consulta);

$sql = "SELECT sum(vlr_total_venta) as vlr_total_venta FROM ventas WHERE fecha = '$fecha' AND vendedor = '$vendedor' AND porcentaje_vendedor = 'si' ORDER BY fecha DESC";
