...
//----------------------------------------------------------------------- -----------------------------------------------------------------------------------------------//
$mostrar_datos_sql = "SELECT cod_productos, cod_factura, nombre_productos, unidades_vendidas, fecha, fecha_anyo  FROM ventas 
WHERE cod_productos = '$cod_productos' AND fecha_mes = '$fecha_mes' ORDER BY fecha DESC";
...
<br><br>
<td><strong><font color='yellow' size="+2">KARDEX VENTAS: </font></strong></td><br><br>
<table width="90%">
<tr>
...
<td align="center"><font size= "+1"><?php echo $unidades_vendidas; ?></font></td>
