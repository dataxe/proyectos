...
?>
<tr>
<td ><a href="../admin/buscar_facturas_listado.php?cod_factura=<?php echo $cod_facturan?>"><center><?php echo $cod_facturan?></center></a></td>
<td align='center'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'cod_productos', <?php echo $cod_ventas;?>)" class="cajgrand" id="<?php echo $cod_ventas;?>" value="<?php echo $cod_productos;?>" size="3"></td>
...
<td><font><?php echo $detalles; ?></td></font>
<td align='center'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'precio_venta', <?php echo $cod_ventas;?>)" class="cajextragrand" id="<?php echo $cod_ventas;?>" value="<?php echo $precio_venta;?>" size="3"></td>
