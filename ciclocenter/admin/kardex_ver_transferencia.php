...
//----------------------------------------------------------------------- -----------------------------------------------------------------------------------------------//
$mostrar_datos_sql = "SELECT transferencias.cod_productos, transferencias.nombre_productos, transferencias.unidades_total, transferencias.cod_factura, 
transferencias_almacenes.nombre_almacen, transferencias.fecha_anyo, transferencias.fecha_mes
FROM transferencias_almacenes INNER JOIN transferencias ON transferencias_almacenes.cod_transferencias_almacenes = transferencias.cod_transferencias_almacenes
WHERE (((transferencias.cod_productos)='$cod_productos') AND ((transferencias.fecha_mes)='$fecha_mes')) ORDER BY fecha DESC";
...
<br><br>
<td><strong><font color='yellow' size="+2">KARDEX TRANSFERENCIAS (OUT): </font></strong></td><br><br>
<table width="90%">
<tr>
