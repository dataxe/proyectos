...
//currentMonth.setMonth(3);
//currentMonth.setFullYear(1985);
var isVisible=false;
...
//alert("From Date : "+calendarFrom);
findToDate();
//alert("To Date   : "+calendarTo);
...
cell2.colSpan=5;
month_names = new Array("ENERO","FEBRERO","MARZO","ABRIL","MAYO","JUNIO",
...
day_names = new Array("Dom","Lun","Mar","Mie","Jue","Vie","Sab");
for(i=0;i<7;i++){
...
cell2.colSpan=2;
cell2.appendChild(getNumList(0, 55,"jc_minute"));
