...
$mostrar_datos_sql = "SELECT distinct facturas_cargadas_inv.cod_factura, facturas_cargadas_inv.cod_proveedores, proveedores.nombre_proveedores, facturas_cargadas_inv.tipo_pago, facturas_cargadas_inv.fecha_anyo 
