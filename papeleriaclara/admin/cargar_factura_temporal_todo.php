...
<td align='right' title="Total valor facturado. (P.COST-FACT * %IVA) * PRE"><?php echo number_format($precio_compra_con_descuento);?></td>
<!--
...
-->
<td align='right' title="Precio costo en metrica. (P.COST-FACT / UN.MET) - (P.COST-FACT * %IVA)"><?php echo number_format($precio_costo);?></td>
<?php
