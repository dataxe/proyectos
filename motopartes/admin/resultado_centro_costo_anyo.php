...
FROM ventas WHERE anyo = '$anyo' AND nombre_ccosto = '$nombre_ccosto' ORDER BY fecha_hora DESC";
...
$mostrar_datos_sql = "SELECT * FROM ventas WHERE anyo = '$anyo' AND nombre_ccosto = '$nombre_ccosto' ORDER BY fecha_hora DESC";
...
<table align="center">
<td nowrap align="right">A&Ntilde;O - CENTRO COSTO:</td>
<td bordercolor="0">
<select name="fecha">
<?php $sql_consulta1="SELECT DISTINCT anyo, nombre_ccosto FROM ventas ORDER BY fecha DESC";
$resultado = mysql_query($sql_consulta1, $conectar) or die(mysql_error());
while ($contenedor=mysql_fetch_array($resultado)) {?>
<option value="<?php echo $contenedor['anyo'].'-'.$contenedor['nombre_ccosto'] ?>"><?php echo $contenedor['anyo'].' - '.$contenedor['nombre_ccosto'] ?></option>
<?php }?>
</select></td></td>
<tr valign="baseline">
