...
$sql_modificar_consulta = "SELECT * FROM pedidos_temporal WHERE cod_productos = '$cod_productos'";
...
mysql_query("UPDATE pedidos_temporal SET cajas = '$cajas', unidades_vendidas = '$unidades_vendidas', unidades_total = '$unidades_total',
...
mysql_query("UPDATE pedidos_temporal SET unidades = '$unidades', unidades_vendidas = '$unidades_vendidas', unidades_total = '$unidades_total',
precio_costo = '$precio_costo', valor_iva = '$valor_iva', precio_compra_con_descuento = '$precio_comp_dto', descuento = '$descuento', 
vlr_total_compra = '$vlr_total_compra' WHERE cod_productos = '$cod_productos'", $conectar);
}  
...
mysql_query("UPDATE pedidos_temporal SET precio_compra = '$precio_compra', precio_costo = '$precio_costo', valor_iva = '$valor_iva', 
...
mysql_query("UPDATE pedidos_temporal SET dto1 = '$dto1', precio_compra_con_descuento = '$precio_comp_dto', precio_costo = '$precio_costo', 
...
mysql_query("UPDATE pedidos_temporal SET dto2 = '$dto2', precio_compra_con_descuento = '$precio_comp_dto', precio_costo = '$precio_costo', 
vlr_total_compra = '$vlr_total_compra', descuento = '$descuento' WHERE cod_productos = '$cod_productos'", $conectar);
}
if ($campo == 'iva') {
$iva = $valor_intro;
...
mysql_query("UPDATE pedidos_temporal SET iva = '$iva', valor_iva = '$valor_iva', precio_compra_con_descuento = '$precio_comp_dto',
...
mysql_query("UPDATE pedidos_temporal SET precio_venta = '$precio_venta', vlr_total_compra = '$vlr_total_compra', precio_costo = '$precio_costo', 
...
mysql_query("UPDATE pedidos_temporal SET porcentaje_vendedor = '$porcentaje_vendedor' WHERE cod_productos = '$cod_productos'", $conectar);
}
if ($campo == 'ptj_ganancia') {
$ptj_ganancia = $valor_intro;
mysql_query("UPDATE pedidos_temporal SET ptj_ganancia = '$ptj_ganancia' WHERE cod_productos = '$cod_productos'", $conectar);
}
...
mysql_query("UPDATE pedidos_temporal SET fechas_vencimiento = '$fechas_vencimiento', fechas_vencimiento_seg = '$fecha_recibida_segundos' 
WHERE cod_productos = '$cod_productos'", $conectar);
}
if ($campo == 'tope_min') {
$tope_min = $valor_intro;
mysql_query("UPDATE pedidos_temporal SET tope_min = '$tope_min' WHERE cod_productos = '$cod_productos'", $conectar);
}
if ($campo == 'detalles') {
$detalles = $valor_intro;
mysql_query("UPDATE pedidos_temporal SET detalles = '$detalles' WHERE cod_productos = '$cod_productos'", $conectar);
}
if ($campo == 'iva_v') {
$iva_v = $valor_intro;
mysql_query("UPDATE pedidos_temporal SET iva_v = '$iva_v' WHERE cod_productos = '$cod_productos'", $conectar);
}
if ($campo == 'nombre_productos') {
$nombre_productos = $valor_intro;
mysql_query("UPDATE pedidos_temporal SET nombre_productos = '$nombre_productos' WHERE cod_productos = '$cod_productos'", $conectar);
}
if ($campo == 'cod_original') {
$cod_original = $valor_intro;
mysql_query("UPDATE pedidos_temporal SET cod_original = '$cod_original' WHERE cod_productos = '$cod_productos'", $conectar);
}
if ($campo == 'codificacion') {
$codificacion = $valor_intro;
mysql_query("UPDATE pedidos_temporal SET codificacion = '$codificacion' WHERE cod_productos = '$cod_productos'", $conectar);
}
}
?>