...
<td align='center'><strong>FACTURA: </strong><input type="text" style="font-size:20px" name="numero_factura" tabindex=3 value="<?php if ($cantidad_resultado == '1') {
echo $info['cod_factura']; } else { echo $maxima['cod_factura']+1;}?>" size="3" required autofocus></td>

<td align='left'><strong>FECHA: </strong><input type="text" style="font-size:20px" name="fecha_anyo" tabindex=3 value="<?php echo  date("d/m/Y")?>" size="8" required autofocus></td>

<td><strong>FECHA PAGO: </strong><input type="text" style="font-size:20px" name="fecha_pago" tabindex=3 value="<?php echo  date("d/m/Y")?>" size="8" required autofocus></td>
...
<td align='center'><a><input type="image" src="../imagenes/ok.png" tabindex=3 name="vender" value="Guardar" /></a></td>
</table>
