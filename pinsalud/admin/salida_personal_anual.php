...
$mostrar_datos_sql = "SELECT * FROM salida_personal WHERE anyo = '$fecha' order by anyo DESC";
...
<body>
<center>
<td><strong><font color='yellow' size='+2'>SALIDAS PERSONALES: </font></strong></td><br><br>
<td>
<a href="../admin/agregar_salida_personal.php?pagina=<?php echo $pagina?>"><FONT color='white'>AGREGAR NUEVA SALIDA PERSONAL</FONT></a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="../admin/agregar_concepto_egresos.php"><FONT color='white'>AGREGAR NUEVO CONCEPTO</FONT></a>
</td>
<?php include_once("menu_salidas_personales.php");?>
</center>
<br>
<center>
...
<?php $sql_consulta = "SELECT anyo FROM salida_personal GROUP BY anyo DESC";
...
<?php do { 
$cod_salida_personal = $datos['cod_salida_personal'];
?>
<tr>
<td ><a href="../modificar_eliminar/eliminar_salida_personal.php?cod_salida_personal=<?php echo $cod_salida_personal?>&fecha=<?php echo $fecha?>&pagina=<?php echo $pagina?>"><center><img src=../imagenes/eliminar.png alt="eliminar"></center></a></td>
...
<td ><a href="../modificar_eliminar/modificar_salida_personal.php?cod_salida_personal=<?php echo $cod_salida_personal?>&fecha=<?php echo $fecha?>&pagina=<?php echo $pagina?>"><center><img src=../imagenes/actualizar.png alt="Actualizar"></center></a></td>
</tr>
