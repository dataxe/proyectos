...
?>
<td align="center"><input onblur="validar_codigo(this);" type="text" style="font-size:20px" name="cod_productos_var" value="<?php echo $_GET['plus']?>" id="cod_productos_var" size="20" required autofocus/></td>
