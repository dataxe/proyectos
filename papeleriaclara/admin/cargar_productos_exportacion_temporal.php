...
<?php do { ?>
<td ><a href="../modificar_eliminar/agregar_cargar_exportacion_temporal.php?cod_productos=<?php echo $matriz_consulta['cod_productos_var']; ?>"><center><img src=../imagenes/agregar.png alt="Agregar"></center></a></td>
