...
$mostrar_datos_sql = "SELECT cod_productos, nombre_productos, und_venta, und_compra, und_transf, und_invent, fecha_mes, fecha_seg_ymd, fecha_time 
FROM kardex_venta_compra_invent ORDER BY fecha_seg_ymd DESC";
