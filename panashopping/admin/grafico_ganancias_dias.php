...
$(function () {
    $('#container').highcharts({
        ...
        xAxis: {
            categories: [
<?php
$sql = "SELECT SUM(vlr_total_venta - vlr_total_compra) AS ganacia, fecha_anyo FROM ventas GROUP BY fecha ORDER BY fecha ASC";
...
?>
        ...
        series: [{
            ...
            data: [
<?php
$sql = "SELECT SUM(vlr_total_venta - vlr_total_compra) AS ganacia, fecha FROM ventas GROUP BY fecha ORDER BY fecha ASC";
$result = mysql_query($sql, $conectar) or die(mysql_error());
while ($registros = mysql_fetch_array($result)) {
?>
