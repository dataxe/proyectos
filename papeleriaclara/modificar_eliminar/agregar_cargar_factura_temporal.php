...
'$unidades', '$cajas', '$precio_compra', '$precio_venta', '$precio_costo', '$vlr_total_venta', '$vlr_total_compra', '$precio_compra', 
'$detalles', '$tope_min', '$vendedor', '$ip', '$fecha', '$fecha_mes', '$fechas_vencimiento', '$fechas_vencimiento_seg', 
