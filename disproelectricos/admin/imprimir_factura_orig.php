...
<td align="center"><p style="font-size:14px"><?php echo $dat['cabecera'];?> - <?php echo $dat['localidad'];?>
<p style="font-size:14px">Res: <?php echo $dat['res'];?>, Del <?php echo $dat['res1'];?> Al <?php echo $dat['res2'];?> 
...
<table width="370" align="left">
<td align="left"><p style="font-size:14px"><strong>Fact N&ordm;:</strong> <?php echo $cod_factura;?> | 
...
<td align="right"><strong><p style="font-size:12px">UND-</strong></td>
...
<td align="center"><p style="font-size:12px">&nbsp;&nbsp;&nbsp;<?php echo $info_venta['unidades_vendidas'].''.$info_venta['detalles']; ?></td>
...
<td></td>
<td align='left'><p style="font-size:14px"><strong>SUBTOT:</td>
<td></td>
<td></td>
<td align='right'><p style="font-size:14px"><strong><?php echo number_format($subtotal_base, 0, ",", "."); ?></strong></td>
<tr></tr>
<td></td>
<td align='left'><p style="font-size:14px"><strong>%DESC: </td>
<td></td>
<td></td>
<td align='right'><p style="font-size:14px"><strong><?php echo $descuento.'%'; ?></strong></td>
<tr></tr>
<td></td>
<td align='left'><p style="font-size:14px"><strong>$DESC:</td>
<td></td>
<td></td>
<td align='right'><p style="font-size:14px"><strong><?php echo number_format($total_desc, 0, ",", "."); ?></strong></td>
<tr></tr>
<td></td>
<td align='left'><p style="font-size:14px"><strong>IVA:</td>
<td></td>
<td></td>
<td align='right'> <p style="font-size:14px"><strong><?php echo number_format($total_iva, 0, ",", "."); ?></strong></td>
<tr></tr>
<td></td>
<td align='left'><p style="font-size:14px"><strong>TOTAL:</td>
<td></td>
<td></td>
<td align='right'><p style="font-size:14px"><strong><?php echo number_format($total_venta_temp, 0, ",", "."); ?></strong>
</td>
</tr>
