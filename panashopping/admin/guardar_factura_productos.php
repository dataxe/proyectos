...
unidades_vendidas, unidades_faltantes, precio_compra, precio_costo, precio_venta, vlr_total_venta, vlr_total_compra, 
precio_compra_con_descuento, cod_interno, detalles, cod_proveedores, tipo_pago, dto1, dto2, iva, iva_v, valor_iva, 
cod_factura, cod_original, codificacion, porcentaje_vendedor, ptj_ganancia, vendedor, fecha, fecha_mes, fecha_anyo, 
anyo, fecha_hora, fechas_vencimiento, fechas_vencimiento_seg, ip)
VALUES ('$cod_productos', '$nombre_productos', '$unidades', '$cajas', '$unidades_total', '$unidades_vendidas', 
'$unidades_faltantes_inv', '$precio_compra', '$precio_costo', '$precio_venta', '$vlr_total_venta', '$vlr_total_compra', 
'$precio_compra_con_descuento', '$cod_interno', '$detalles', '$cod_proveedores', '$tipo_pago', '$dto1', '$dto2', '$iva', 
'$iva_v', '$valor_iva', '$cod_factura', '$cod_original', '$codificacion', '$porcentaje_vendedor', '$ptj_ganancia', 
'$vendedor', '$fecha', '$fecha_mes', '$fecha_anyo', '$anyo', '$fecha_hora', '$fechas_vencimiento', '$fechas_vencimiento_seg', '$ip')";
...
unidades_vendidas, unidades_faltantes, precio_compra, precio_costo, precio_venta, vlr_total_venta, vlr_total_compra, 
precio_compra_con_descuento, cod_interno, detalles, cod_proveedores, tipo_pago, dto1, dto2, iva, iva_v, valor_iva, 
cod_factura, cod_original, codificacion, porcentaje_vendedor, ptj_ganancia, vendedor, fecha, fecha_mes, 
fecha_anyo, anyo, fecha_hora, fechas_vencimiento, fechas_vencimiento_seg, ip)
VALUES ('$cod_productos', '$nombre_productos', '$unidades', '$cajas', '$unidades_total', '$unidades_vendidas', 
'$unidades_faltantes_inv', '$precio_compra', '$precio_costo', '$precio_venta', '$vlr_total_venta', '$vlr_total_compra', 
'$precio_compra_con_descuento', '$cod_interno', '$detalles', '$cod_proveedores', '$tipo_pago', '$dto1', '$dto2', '$iva', 
'$iva_v', '$valor_iva', '$cod_factura', '$cod_original', '$codificacion', '$porcentaje_vendedor', '$ptj_ganancia', '$vendedor', 
'$fecha', '$fecha_mes', '$fecha_anyo', '$anyo', '$fecha_hora', '$fechas_vencimiento', '$fechas_vencimiento_seg', '$ip')";
$resultado_facturas_cargadas_inv = mysql_query($agregar_facturas_cargadas_inv, $conectar) or die(mysql_error());
//----------------------------- ACTUALIZAR INVENTARIO DE PRODUCTOS OPERACIONES -----------------------------//
//----------------------------- ACTUALIZAR INVENTARIO DE PRODUCTOS OPERACIONES -----------------------------//
$actualiza_productos = sprintf("UPDATE productos SET 
