...
'$valor_iva', '$cod_factura', '$cod_original', '$codificacion', '$porcentaje_vendedor', '$ptj_ganancia', 
'$vendedor', '$fecha_invert', '$fechas_mes', '$fecha_anyo', '$fecha_hora', '$fechas_vencimiento', '$fechas_vencimiento_seg', 
'$ip', '$anyo')";
