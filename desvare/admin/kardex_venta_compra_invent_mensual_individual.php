...
<?php if ($cod_seguridad == 3 || $cod_seguridad == 2) { ?>
<td align="center"><a href="../admin/actualizar_kardex_mes_todos_campos.php?cod_productos=<?php echo $cod_productos?>&fecha_mes=<?php echo $fecha_mes?>&pagina=<?php echo $pagina?>"><img src=../imagenes/correcto.png alt="ok"></a></td>
<?php } else { } ?>
</tr>
<?php 
}
