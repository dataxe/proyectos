...
<br><br>
<center>
<td align="center"><font color="yellow" size="+2"><strong>DEVOLUCIONES INVENTARIO DIARIO</font></td>
<br>
...
<?php 
$sql_consulta = "SELECT DISTINCT fecha_anyo, fecha FROM operacion ORDER BY fecha DESC";
$resultado = mysql_query($sql_consulta, $conectar) or die(mysql_error());
while ($contenedor = mysql_fetch_array($resultado)) {?>
<option style="font-size:20px" value="<?php echo $contenedor['fecha_anyo'] ?>"><?php echo $contenedor['fecha_anyo']?></option>
<?php }?></select></td>
<tr valign="baseline">
...
$deboluciones_inventario = "SELECT * FROM operacion WHERE origen_operacion = 'productos' AND fecha_anyo = '$fecha'";
