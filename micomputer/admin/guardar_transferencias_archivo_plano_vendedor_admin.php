...
$fecha = $_POST['fecha'];
$cod_factura = $_POST['cod_factura_temp'];
...
//----------------------------------------------------------------------- -----------------------------------------------------------------------------------------------//
//----------------------------------------------------------------------- -----------------------------------------------------------------------------------------------//
$agregar_reg_transferencias = "INSERT INTO transferencias_entrada (cod_productos, cajas, unidades, unidades_total, nombre_productos, cod_original, codificacion, unidades_vendidas, 
precio_compra, precio_costo, precio_venta, dto1, dto2, iva, iva_v, fecha, fecha_mes, fecha_anyo, fecha_hora, ip, cod_factura, cod_transferencias_almacenes, vendedor, 
vlr_total_compra, vlr_total_venta, detalles) 
...
iva, iva_v, '$fecha_seg', '$fecha_mes', '$fechas_anyo', '$fecha_hora', '$ip', '$cod_factura', cod_transferencias_temporal_almacenes, '$cuenta_actual', vlr_total_compra, 
vlr_total_venta, detalles FROM transferencias_temporal WHERE transferencias_temporal.cod_factura = '$cod_factura'";
...
$cod_productos_var = $datos_temp['cod_productos'];
$cod_productos = $datos_temp['cod_productos'];

$nombre_productos = $datos_temp['nombre_productos'];

$sqlr_consulta = "SELECT * FROM productos WHERE cod_productos_var = '$cod_productos_var'";
...
WHERE productos.cod_productos_var = '$cod_productos_var'");
