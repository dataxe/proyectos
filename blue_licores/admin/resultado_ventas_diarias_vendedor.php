...
$buscar = $_POST['fecha'];
$mostrar_datos_sql = "SELECT * FROM ventas WHERE fecha_anyo like '%$buscar%' AND unidades_vendidas <> '0' ORDER BY fecha_hora DESC";
$consulta = mysql_query($mostrar_datos_sql, $conectar) or die(mysql_error());
$matriz_consulta = mysql_fetch_assoc($consulta);

$calcular_total = "SELECT sum(vlr_total_venta) AS total FROM ventas WHERE fecha_anyo like '%$buscar%' AND unidades_vendidas <> '0'";
$consulta_total = mysql_query($calcular_total, $conectar) or die(mysql_error());
$suma_total = mysql_fetch_assoc($consulta_total);
...
<center>
<?php echo "<font color='yellow' size='+3'>Fecha: ".$buscar."</font>";?>
<table width="100%">
<tr>
...
<br><br>
<table width="40%">
<td align="center"><font color='yellow' size='+3'>TOTAL: <?php echo number_format($suma_total['total'])."</font>"; ?></td>
<table>