...
$suma_factura = "SELECT sum(vlr_total_venta) as vlr_total_venta FROM cargar_transferencias_temporal WHERE vendedor = '$cuenta_actual'";
$consulta_suma = mysql_query($suma_factura, $conectar) or die(mysql_error());
$suma = mysql_fetch_assoc($consulta_suma);

$transferencias_temporal = "SELECT * FROM cargar_transferencias_temporal WHERE vendedor = '$cuenta_actual'";
