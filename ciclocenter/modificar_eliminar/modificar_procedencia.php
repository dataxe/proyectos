...
$nombre_paises = mysql_escape_string($_POST['nombre_paises']);

if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "formulario_de_actualizacion")) {
  $actualizar_sql = sprintf("UPDATE paises SET nombre_paises=%s WHERE cod_paises=%s",
                       envio_valores_tipo_sql($nombre_paises, "text"),
...
echo '<META HTTP-EQUIV="REFRESH" CONTENT="0.1; ../admin/procedencia.php">';
}
$cod_paises = mysql_escape_string($_GET['cod_paises']);

$sql_modificar_consulta = "SELECT * FROM paises where cod_paises = $cod_paises";
...
<td><?php echo $matriz_modificar_consulta['cod_paises']; ?></td>
</tr>
<tr valign="baseline">
<td nowrap align="right">Nombre:</td>
<td><input type="text" name="nombre_paises" value="<?php echo $matriz_modificar_consulta['nombre_paises']; ?>" size="30"></td>
</tr>
<tr valign="baseline">
...
<input type="hidden" name="cod_paises" value="<?php echo $matriz_modificar_consulta['cod_paises']; ?>">
</form>
</center>
<p>&nbsp;</p>
</body>
