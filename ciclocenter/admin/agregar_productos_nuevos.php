...
echo "<center><font color='yellow'><br><img src=../imagenes/advertencia.gif alt='Advertencia'> El codigo: <strong> ".$cod_productos_var. " </strong>ya existe. 
