...
<td align="center" title=""><strong>CAJ</strong></td>
<td align="center" title=""><strong>MET</strong></td>
<td align="center" title=""><strong>UND</strong></td>
...
<td align="center" title="Precio costo total del producto"><strong>P.VENTA DESC</strong></td>
<td align="center" title="Precio venta total del producto"><strong>P.VENTA.X MAYOR</strong></td>
</tr>
<tr>
<?php
//-------------HABILITAR ESTA OPCION CUANDO LA BARRAS ES LARGA----------------//
...
?>
<td align="center"><input onblur="validar_codigo(this);" type="text" style="font-size:20px" name="cod_productos_var" id="cod_productos_var" value="<?php echo $_GET['plus'] ?>" size="12" required autofocus/></td>

<td align="center" title="Nombre del producto"><input type="text" style="font-size:20px" name="nombre_productos" value="" size="20" required autofocus></td>

<td align="center" title=""><input type="text" style="font-size:20px" name="unidades" value="" size="1" required autofocus></td>

<td align="center" title=""><select name="nombre_metrica">
...
<td align="center" title=""><input type="text"style="font-size:20px" name="precio_costo" value="" size="4" required autofocus></td>
<td align="center" title=""><input type="text" style="font-size:20px" name="precio_venta" value="" size="4" required autofocus></td>
<td align="center" title=""><input type="text"style="font-size:20px" name="vlr_total_venta" value="" size="4" required autofocus></td>
<td align="center" title=""><input type="text" style="font-size:20px" name="precio_compra" value="" size="4" required autofocus></td>

<!--<td align="center"><input type="text" style="font-size:20px" name="descripcion" value="" size="12"></td>-->
