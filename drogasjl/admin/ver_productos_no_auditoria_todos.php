...
$mostrar_datos_sql = "SELECT cod_productos FROM camparacion_tablas GROUP BY cod_productos DESC";
...
<td><strong><font color='yellow' size='+2'>VER LA LISTA DE TODOS LOS PRODUCTOS NO INCLUIDOS EN AUDIRORIAS</font></strong></td><br><br>

<form method="post" name="formulario" action="ver_productos_no_incluidos_auditoria_todos.php">
<table width="80%">
<?php do { 
