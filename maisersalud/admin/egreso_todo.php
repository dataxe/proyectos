...
$datos_sql = "SELECT SUM(costo) AS costo FROM egresos order by fecha_invert DESC";
...
<?php
echo "<BR><font color ='yellow' size='+3'><table>TOTAL: ".number_format($total_egreso['costo'], 0, ",", ".")."</table>";
?>
<center>
<table width="85%">
<tr>
