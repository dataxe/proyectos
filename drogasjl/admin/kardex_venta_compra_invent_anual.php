...
<table align="center">
<td align="center"><select name="anyo">
<?php $sql_consulta="SELECT anyo, fecha_seg_ymd FROM kardex_venta_compra_invent GROUP BY anyo ORDER BY fecha_seg_ymd DESC";
$resultado = mysql_query($sql_consulta, $conectar) or die(mysql_error());
while ($contenedor=mysql_fetch_array($resultado)) {?>
<option style="font-size:16px" value="<?php echo $contenedor['anyo'] ?>"><?php echo $contenedor['anyo'] ?></option>
<?php }?>
</select></td>
...
FROM kardex_venta_compra_invent WHERE anyo = '$anyo' ORDER BY fecha_seg_ymd DESC";
...
<td align="right"><a href="../admin/kardex_ver_transferencia.php?cod_productos=<?php echo $cod_productos?>&fecha_mes=<?php echo $fecha_mes?>&pagina=<?php echo $pagina?>"><font size= "+1"><?php echo number_format($und_transf, 0, ",", "."); ?></font><img src=../imagenes/mas.png alt="mas"></a></td>
...
<td align="center"><a href="../admin/kardex_ver_nombre_productos.php?cod_productos=<?php echo $cod_productos?>&pagina=<?php echo $pagina?>"><img src=../imagenes/bien.png alt="bien"></a></td>
</tr>
<?php 
}
