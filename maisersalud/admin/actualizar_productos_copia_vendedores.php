...
$mostrar_datos_sql = "SELECT * FROM productos WHERE (nombre_productos like '$buscar%' OR cod_productos_var = '$buscar') ORDER BY nombre_productos ASC";
...
<td><a href="../modificar_eliminar/productos_actualizar_inventario_copia_vendedores.php?cod_productos=<?php echo $cod_productos_var; ?>"><?php echo $datos['nombre_productos'];?></center></a></td>
