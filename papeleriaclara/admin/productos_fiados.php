...
$sql = "SELECT * FROM productos_fiados, clientes WHERE productos_fiados.cod_clientes = '$cod_clientes' 
...
$abonado = $sum_abonos['sum_abonados'];

mysql_query("UPDATE cuentas_cobrar SET monto_deuda = '$monto_deuda', abonado = '$abonado' WHERE cod_clientes = '$cod_clientes'", $conectar);
?>
<br>
<center>
...
<br>
<table>
<td align="right"><font size="7">TOTAL VENTA: <?php echo number_format($monto_deuda, 0, ",", "."); ?></font></td>
</table>
<?php
} else {
echo "<br><td><strong><font color='yellow'>NO HAY DATOS QUE MOSTRAR</font></strong></td>";
}
?>
</form>