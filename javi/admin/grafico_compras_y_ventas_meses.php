...
$fecha_anyo = $registros["fecha_mes"]
?>
'<?php echo $fecha_anyo ?>',
<?php
}
?>
        ...
        series: [{
            ...
            data: [
<?php
$sql = "SELECT SUM(vlr_total_venta) AS total_venta FROM ventas GROUP BY fecha_mes ORDER BY fecha ASC";
$result = mysql_query($sql, $conectar) or die(mysql_error());
while ($registros = mysql_fetch_array($result)) {
?>
<?php echo $registros["total_venta"] ?>,
<?php
}
?>
            ],
            ...
            data: [
<?php
$sql = "SELECT SUM(precio_costo*unidades_total) AS total_compra FROM facturas_cargadas_inv GROUP BY fecha_mes ORDER BY fecha ASC";
$result = mysql_query($sql, $conectar) or die(mysql_error());
while ($registros = mysql_fetch_array($result)) {
?>
<?php echo $registros["total_compra"] ?>,
<?php
}
?>
            ],
