...
<td align="center">RAYA <br><a href="../admin/inventario_productos.php?campo=porcentaje_vendedor&ord=asc"><img src=../imagenes/asc.png alt="asc"></a></td>
<?php
} else {
?>
...
<td align="center">RAYA <br><a href="../admin/inventario_productos.php?campo=porcentaje_vendedor&ord=desc"><img src=../imagenes/desc.png alt="desc"></a></td>
<?php }?>
</tr>
<?php 
...
<td align='center'><input onFocus="Focus(this.id, this.value)" onBlur="Blur(this.id, this.value, 'porcentaje_vendedor', <?php echo $cod_productos;?>)" class="cajpequena" id="<?php echo $cod_productos;?>" value="<?php echo $porcentaje_vendedor;?>" size="3"></td>
</tr>
<?php } ?>
</table>
</form>
