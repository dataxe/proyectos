...
<td align="center"><p style="font-size:13px"><?php echo $dat['cabecera'];?> - <?php echo $dat['localidad'];?>
<p style="font-size:13px">Res: <?php echo $dat['res'];?>, Del <?php echo $dat['res1'];?> Al <?php echo $dat['res2'];?> 
...
<table width="370" align="left">
<td align="left"><p style="font-size:13px"><strong>Fact N&ordm;:</strong> <?php echo $cod_factura;?> | 
...
<td align="right"><strong><p style="font-size:9px">V.UNITt</strong></td>
