...
<ul class="menu">
	...
	<li><a href="inventario_productos_no_editable.php">Inventario</a></li>
	...
	<li><a href="#">Facturaci&oacute;n</a>
		   ...
		   <li><a href="#">Factura Venta</a></li>
		   <li><a href="#">Factura Compra</a></li>
		   <li><a href="#">Devol Inventario</a></li>
		   <li><a href="#">Devol Ventas</a></li>
	...
	<li><a href="#">Ventas</a>
		    <ul>
		       ...
		       <li><a href="../admin/ventas_todas.php">Venta Todas</a></li>
				...
				<li><a href="#">Tope Minimo</a></li>
		    </ul>
	</li>
	<li><a href="#">Cuentas</a>
			<ul>
				<li><a href="#">Por cobrar</a></li>
				<li><a href="#">Por pagar</a></li>
				<li><a href="#">Centro costo</a></li>
