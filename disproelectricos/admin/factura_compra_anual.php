...
sum(vlr_total_venta * cajas) AS vlr_total_ventas FROM facturas_cargadas_inv WHERE anyo = '$fecha'";
...
$mostrar_datos_sql = "SELECT * FROM facturas_cargadas_inv, proveedores WHERE anyo = '$fecha' 
...
<table align="center">
<td nowrap align="right">FACTURA COMPRA ANUAL:</td>
<td bordercolor="0">
<select name="fecha" id="foco">
<?php $sql_consulta1="SELECT DISTINCT anyo FROM facturas_cargadas_inv ORDER BY anyo DESC";
...
if ($fecha <> NULL) {?>
<center>
<fieldset><legend><font color='yellow' size='+3'>COMPRAS TOTALES A&Ntilde;O: <?php echo $fecha.' - '.$hora;?></font></legend>
<table width='40%'>
<br>
<tr>
...
-->
<br>
<fieldset><legend><font color='yellow' size='+3'>COMPRA A&Ntilde;O: <?php echo $fecha.' - '.$hora;?></font></legend>
<table width='100%'>
<tr>
