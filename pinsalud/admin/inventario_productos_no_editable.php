...
<td align="center" title='Cuantas unidades trae la caja. Presentacion'>UND.CAJ <br><a href="../admin/inventario_productos_no_editable.php?campo=unidades&ord=asc"><img src=../imagenes/asc.png alt="asc"></a></td>
<td align="center" title='Unidades totales en inventario'>UND.INV <br><a href="../admin/inventario_productos_no_editable.php?campo=unidades_faltantes&ord=asc"><img src=../imagenes/asc.png alt="asc"></a></td>
<td align="center">P.COSTO <br><a href="../admin/inventario_productos_no_editable.php?campo=precio_costo&ord=asc"><img src=../imagenes/asc.png alt="asc"></a></td>
<td align="center">P.VENTA <br><a href="../admin/inventario_productos_no_editable.php?campo=precio_venta&ord=asc"><img src=../imagenes/asc.png alt="asc"></a></td>
<td align="center">P.VENTA2<br><a href="../admin/inventario_productos_no_editable.php?campo=vlr_total_venta&ord=asc"><img src=../imagenes/asc.png alt="asc"></a></td>
<?php
} else {
?>
...
<td align="center" title='Cuantas unidades trae la caja. Presentacion'>UND.CAJ <br><a href="../admin/inventario_productos_no_editable.php?campo=unidades&ord=desc"><img src=../imagenes/desc.png alt="desc"></a></td>
<td align="center" title='Unidades totales en inventario'>UND.INV <br><a href="../admin/inventario_productos_no_editable.php?campo=unidades_faltantes&ord=desc"><img src=../imagenes/desc.png alt="desc"></a></td>
<td align="center">P.COSTO <br><a href="../admin/inventario_productos_no_editable.php?campo=precio_costo&ord=desc"><img src=../imagenes/desc.png alt="desc"></a></td>
<td align="center">P.VENTA <br><a href="../admin/inventario_productos_no_editable.php?campo=precio_venta&ord=desc"><img src=../imagenes/desc.png alt="desc"></a></td>
<td align="center">P.VENTA2 <br><a href="../admin/inventario_productos_no_editable.php?campo=vlr_total_venta&ord=desc"><img src=../imagenes/desc.png alt="desc"></a></td>
<?php }?>
</tr>
<?php 
