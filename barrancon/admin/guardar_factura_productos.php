...
precio_compra_con_descuento, detalles, cod_proveedores, tipo_pago, dto1, dto2, iva, iva_v, valor_iva, cod_factura, 
cod_original, codificacion, porcentaje_vendedor, ptj_ganancia, vendedor, fecha, fecha_mes, fecha_anyo, fecha_hora, 
fechas_vencimiento, fechas_vencimiento_seg, ip, anyo)
...
'$precio_compra_con_descuento', '$detalles', '$cod_proveedores', '$tipo_pago', '$dto1', '$dto2', '$iva', '$iva_v', 
'$valor_iva', '$cod_factura', '$cod_original', '$codificacion', '$porcentaje_vendedor', '$ptj_ganancia', '$vendedor', 
'$fecha_invert', '$fechas_mes', '$fecha', '$fecha_hora', '$fechas_vencimiento', '$fechas_vencimiento_seg', '$ip', '$anyo')";
