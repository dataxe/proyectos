...
$mostrar_datos_sql = "SELECT * FROM productos WHERE (nombre_productos like '%$buscar%' OR cod_productos_var like '%$buscar%' OR nombre_marcas like '%$buscar%')
...
<?php require_once("../busquedas/busqueda_productos.php");?>
<body>
<p>
<center>
...
<td><div align="center" ><strong>Codif</strong></div></td>
