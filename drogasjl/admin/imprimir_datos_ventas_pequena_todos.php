...
Sum(((precio_venta/1.16)*(iva/100))*unidades_vendidas) As sum_iva FROM ventas";
...
$total_descuento_dia = $desc_venta_fact['descuento_facturas'];
...
<td align='right'><p style="font-size:15px"><strong><?php echo number_format((($total_venta) / $vlr_total_compra) * 100).'%'; ?></strong></td>
<tr></tr>
