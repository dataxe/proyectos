...
$mostrar_datos_sql = "SELECT * FROM egresos WHERE anyo = '$fecha' order by fecha_invert DESC";
$consulta = mysql_query($mostrar_datos_sql, $conectar) or die(mysql_error());
$datos = mysql_fetch_assoc($consulta);

$datos_sql = "SELECT SUM(costo) AS costo FROM egresos WHERE anyo = '$fecha' order by fecha_invert DESC";
...
<table>
<tr>
<td align="center"><strong>A&NtildeO</strong></td>
<td><select name="fecha" require autofocus>
<?php $sql_consulta="SELECT DISTINCT anyo FROM egresos ORDER BY anyo DESC";
...
<?php
if (isset($_GET['fecha'])) {
echo "<font color ='yellow' size='+3'>RESULTADOS PARA: ".$fecha."</font>";
