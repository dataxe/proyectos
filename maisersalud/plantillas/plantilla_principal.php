...
<ul class="menu">
	<li><a href="#">Productos</a>
		<ul>
			 ...
			 <li><a href="../admin/pregunta_hacer_copia_del_inventario.php">Copia Invent</a></li>
	    </ul>
	</li>
	<li><a href="../admin/proveedores.php">Proveedores</a></li>
	<li><a href="menu_inventario.php">Inventario</a></li>
	...
	<li><a href="#">Facturaci&oacute;n</a>
		   ...
		   <li><a href="../admin/ver_actualizar_fecha_vencimiento.php">Ver Fact Vencimit</a></li>
	...
	<li><a href="#">Ventas</a>
		    <ul>
		    	...
		    	<li><a href="../admin/ventas_temporal_vendedor.php">Reg Vendedor</a></li>
		    	<li><a href="../admin/agregar_venta_vendedor.php">Agreg Vent Vendr</a></li>
	...
	<li><a href="#">Cuentas</a>
			<ul>
				...
				<li><a href="../admin/ver_caja_registro_fisico.php">Caja Fisica</a></li>
				<li><a href="../admin/listado_caja_registro_admin.php">Listado Caja</a></li>
				<li><a href="../admin/entrada_personal_diario.php">Entradas</a></li>
				<li><a href="../admin/salida_personal_diario.php">Salidas</a></li>
			</ul>
	</li>
