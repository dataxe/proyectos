...
<td align='center'><input type="hidden" style="font-size:20px" tabindex=3 name="numero_factura" value="<?php if ($cantidad_resultado == '1') {
...
<input type="hidden" style="font-size:20px" tabindex=3 name="fecha_anyo" value="<?php echo  date("d/m/Y")?>" size="8" required autofocus>
