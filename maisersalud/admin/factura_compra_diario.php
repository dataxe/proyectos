...
$mostrar_datos_sql = "SELECT * FROM facturas_cargadas_inv WHERE fecha_anyo = '$fecha' ORDER BY cod_facturas_cargadas_inv DESC";
...
<td align="center"><strong>U.ANT</strong></td>
